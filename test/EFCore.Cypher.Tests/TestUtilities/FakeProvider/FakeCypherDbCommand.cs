...
{
    public class FakeCypherDbCommand : DbCommand
    {
        ...
        protected override DbParameter CreateDbParameter()
            => new FakeCypherDbParameter();

        protected override DbParameterCollection DbParameterCollection { get; }
            = new FakeCypherDbParameterCollection();
        ...
        private void AssertTransaction()
        {
            if (Transaction == null)
            {
                Debug.Assert(((FakeCypherDbConnection)DbConnection).ActiveTransaction == null);
            }
            else
            {
                var transaction = (FakeCypherDbTransaction)Transaction;
